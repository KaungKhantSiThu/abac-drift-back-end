globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import devalue from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withQuery, joinURL } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/ohmyfetch/dist/node.mjs';
import { createRouter as createRouter$1 } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/unstorage/dist/drivers/fs.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _rWeCNWAbzc = async (_nitroApp) => {
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!html) {
    const { template } = await import('file:///Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const _lazy_gvEdyQ = () => Promise.resolve().then(function () { return _email_$1; });
const _lazy_rnMm2G = () => Promise.resolve().then(function () { return index$3; });
const _lazy_Z1XUxG = () => Promise.resolve().then(function () { return create_post$3; });
const _lazy_TsUmnD = () => Promise.resolve().then(function () { return _id_$3; });
const _lazy_dXyeGV = () => Promise.resolve().then(function () { return _id__put$3; });
const _lazy_SHqSxM = () => Promise.resolve().then(function () { return _id__delete$3; });
const _lazy_r6ptTD = () => Promise.resolve().then(function () { return index$1; });
const _lazy_uP4Gq1 = () => Promise.resolve().then(function () { return create_post$1; });
const _lazy_s7Umjx = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_kAM2wD = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_GrTkV7 = () => Promise.resolve().then(function () { return _id__delete$1; });
...
const handlers = [
  ...
  { route: '/api/users/:email', handler: _lazy_gvEdyQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/motorcycles', handler: _lazy_rnMm2G, lazy: true, middleware: false, method: undefined },
  { route: '/api/motorcycles/create', handler: _lazy_Z1XUxG, lazy: true, middleware: false, method: "post" },
  { route: '/api/motorcycles/:id', handler: _lazy_TsUmnD, lazy: true, middleware: false, method: undefined },
  { route: '/api/motorcycles/:id', handler: _lazy_dXyeGV, lazy: true, middleware: false, method: "put" },
  { route: '/api/motorcycles/:id', handler: _lazy_SHqSxM, lazy: true, middleware: false, method: "delete" },
  { route: '/api/appointments', handler: _lazy_r6ptTD, lazy: true, middleware: false, method: undefined },
  { route: '/api/appointments/create', handler: _lazy_uP4Gq1, lazy: true, middleware: false, method: "post" },
  { route: '/api/appointments/:id', handler: _lazy_s7Umjx, lazy: true, middleware: false, method: undefined },
  { route: '/api/appointments/:id', handler: _lazy_kAM2wD, lazy: true, middleware: false, method: "put" },
  { route: '/api/appointments/:id', handler: _lazy_GrTkV7, lazy: true, middleware: false, method: "delete" },
  { route: '/__nuxt_error', handler: _lazy_SHEuVB, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SHEuVB, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/Users/kaungkhantsithu/Documents/GitHub/abac-drift-back-end/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
